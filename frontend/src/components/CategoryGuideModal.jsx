...
const CATEGORY_GUIDE = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Partial Visible Body', desc: 'Only part of the pet\'s body is visible in the frame (e.g., cropped or cut off).' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Standing still-posed', desc: 'Pet is standing still, alert, or posed (not sitting or lying down).' },
